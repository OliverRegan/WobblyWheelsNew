                        ...
                        <div className={"my-3 "}>
                            <div className="row w-100 mx-auto justify-content-end " id='login'>
                                <div className={"  my-auto col-md-2 " + (loggedIn ? "d-none" : "")}>
                                    <Link to="/loginSignUp" className='text-decoration-none' onClick={() => props.setLoginType('login')}>
                                        <u className="text-shadow-orange w-100 m-0 nav-link-custom hover-secondary">Login</u>
                                    </Link>
                                </div>
                                <div className={"  my-auto col-md-2 " + (loggedIn ? "d-none" : "")}>
                                    <Link to="/loginSignUp" className='text-decoration-none' onClick={() => props.setLoginType('signUp')}>
