                            ...
                            <div className="row">
                                <form onSubmit={handleSubmit} className="col-6 mx-auto" id={'mainForm'}>
                                    ...
                                    <div className='d-flex my-4'>
                                        ...
                                        <input type="text" name="firstName" className='form-control' onChange={event => setFirstName(event.target.value)} ref={firstNameInput} />
                                    </div>
                                    <div className='d-flex my-4'>
                                        <label htmlFor="firstName" className='col-3'>
                                            Last Name:
                                        </label>
                                        <input type="text" name="lastName" className='form-control' onChange={event => setLastName(event.target.value)} ref={lastNameInput} />
                                    </div>
                                    <div className='d-flex my-4'>
                                        <label htmlFor="firstName" className='col-3'>
                                            Date of Birth:
                                        </label>
                                        <input type="date" name="DOB" className='form-control' onChange={event => setDob(event.target.value)} ref={DOBInput} />
                                    </div>
                                    <div className='d-flex my-4'>
                                        <label htmlFor="firstName" className='col-3'>
                                            Emergency Contact Number:
                                        </label>
                                        <input type="number" name="contact" className='form-control' onChange={event => setContact(event.target.value)} ref={emergencyInput} />
                                    </div>
                                    <div className='d-flex my-4 justify-content-center'>
                                        <button className='custom-btn-any-width btn col-3 mx-2'>Submit</button>
                                        <Link to="/profile" className='btn btn-secondary col-3 mx-2' onClick={(e) => {
                                            dispatch(unset())
                                        }}>
