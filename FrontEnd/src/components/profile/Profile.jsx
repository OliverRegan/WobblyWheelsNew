...
const Profile = props => {
    ...
    function deleteSkater(skater) {
        ...
        // Send data to server
        fetch(("http://localhost:3001/users/deleteSkater"), {
            method: "POST",
            headers: headers,
    ...
    return (
        <div className="d-flex flex-column justify-content-center big-height my-3 mx-auto">
                            ...
                            <div className="row">
                                <div className="col-12 d-flex flex-column">
                                    <div className="row justify-content-center">
                                        <p className="col-md-3 text-start">Username:</p>
                                        <p className="col-md-3 text-start">{userData.username}</p>
                                    ...
                                    <div className="row justify-content-center">
                                        <p className="col-md-3 text-start">Email:</p>
                                        <p className="col-md-3 text-start">{userData.email}</p>
                                        {editingProfile ? <a className={'col-1 text-light'} onClick={() => {
                                            openEditInformation('email')
                                        }}><FontAwesomeIcon icon={faPenToSquare} className="hover-icon-light" /></a> : ''}
                                    </div>
                                    <div className="row justify-content-center">
                                        <p className="col-md-3 text-start">Contact:</p>
                                        <p className="col-md-3 text-start">{userData.contact}</p>
                                        {editingProfile ? <a className={'col-1 text-light'} onClick={() => {
                                    ...
                                    {userData.skaters.map((skater) => {
                                        return <li className="list-group-item text-start">
                                            <div className='row'>
                                                ...
                                                <p className='col-5'>{skater.skaterName + " " + skater.skaterLastName}</p>

                                            </div>
                                            <div className='row'>
                                                <p className='col-5'>Date of birth:</p>
                                                <p className='col-5'>{skater.skaterDOB}</p>

                                            </div>
                                            <div className='row'>
                                                <p className='col-5'>Emergency contact number:</p>
                                                <p className='col-5'>{skater.skaterEmergencyContact}</p>
