    ...
    return (
        <div>
            ...
            <div className="mx-auto w-85 justify-content-between">
                <div className="bg-light shadow  mt-4 rounded d-flex">
                    <div className="card-content d-flex">
                        <div className=''>
                            ...
                            <div className="px-3 img-mobile text-center">
                                <img src={safetyImage} className="img-fluid overflow-hidden rounded" height={"100%"} />
                            </div>
                            <div className="my-5 text-bigger row justify-content-around">
                                <div className="row justify-content-center text-center px-4 mx-4">
                                    <p className="intro-text px-4">We take safety very seriously as the occasional fall in
                                    ...
                                    <p className="intro-text">Download and read through our waiver, it will need to be signed
                                        and
                                        acknowledged
                                        before your
