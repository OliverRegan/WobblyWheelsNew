        ...
        if (isValid.error) {
            ...
            changePasswordCheck(data).then(data => {
                ...
                if (!data.error) {
                    ...
                    dispatch(set)
                    props.setLoginType('changePasswordChange')
                    setMessage('')
                            ...
                            <div className="card-body">
                                ...
                                <form onSubmit={handleSubmit} className="form-group row">
                                    ...
                                    <div className={"row w-75 mx-auto my-2 " + (props.type === 'changePasswordChange' ? 'd-none' : '')}>
                                        ...
                                        <input type="text" name="userName" className="form-control col" onChange={(e) => {
                                    ...
                                    <div className={"row w-75 mx-auto my-2 " + (props.type !== 'changePassword' ? '' : 'd-none') + (props.type !== 'changePasswordFinal' ? '' : 'd-none')}>
                                        ...
                                        <input type="password" name="password" className={"form-control col " + ((password.length > 0 && password.length < 8) ? 'border-danger' : '')} onChange={(e) => {
                                    ...
                                    <div className={"row w-75 mx-auto my-2 " + (props.type === 'changePasswordFinal' ? '' : 'd-none')}>
                                        ...
                                        <input type="number" name="resetCode" className="form-control col" onChange={(e) => { setResetCode(e.target.value) }} />
                                        <label className="col-md-3"></label>
                                    </div>
                                    ...
                                    </div>
                                    {
                                        props.type === 'login' ?
                                            ...
                                            <Link to="/changePassword" className='text-decoration-none' onClick={() => { props.setLoginType('changePassword') }}>
